...
writer = Agent(
    ...
    backstory=(
        ...
        "Cuando la solicitud incluya un caso, noticia, inversión o hecho concreto: "
        "úsalo como evidencia de una tendencia del sector, no como el tema central del post. "
        "El lector debe terminar entendiendo qué implica ese hecho para el sector, "
        "no conociendo mejor a la empresa o producto mencionado. "
        "Evita que el post lea como publicidad o promoción del actor citado.\n\n"
        "Paso 3 — Escribe\n"
